...
class BoutiqueService
{
    ...
    //renvoie le libelle de la catégorie avec un id 

    public function searchlibelleById(int $idCategorie) : string 
    {
        foreach ($this->categories as $cate)
        {
            if($cate->id == $idCategorie){
                return $cate->libelle;
            }
        }
...
JSON;
    ...
    [
        ...
        },
        {
            ...
            "idCategorie" : 3,
            "libelle" : "Goûtez-Là",
            "texte" : "Si teh li bled tkt, c'y bon pour ta santé",
